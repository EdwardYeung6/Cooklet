...
import static com.example.cooklet.Notification.CHANNEL_1_ID;
import static com.example.cooklet.Notification.CHANNEL_2_ID;

public class MainActivity_Instruction extends AppCompatActivity {
    ...
    final ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            if (position == 0) {
                android.app.Notification notification = new NotificationCompat.Builder(MainActivity_Instruction.this, CHANNEL_2_ID)
    ...
    public void startTimer1() {
        android.app.Notification notification = new NotificationCompat.Builder(MainActivity_Instruction.this, CHANNEL_1_ID)
                .setSmallIcon(R.drawable.coolkle_icon_round_removebg)
